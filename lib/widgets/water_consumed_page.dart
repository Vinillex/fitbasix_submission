...
class WaterConsumedPage extends ConsumerStatefulWidget {
  const WaterConsumedPage({Key? key}) : super(key: key);

  @override
  ConsumerState<WaterConsumedPage> createState() => _WaterConsumedPageState();
}

class _WaterConsumedPageState extends ConsumerState<WaterConsumedPage> {
  int limit = 0;
